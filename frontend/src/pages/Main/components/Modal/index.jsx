...
import { CancleBtn, ContentContainer, InfoContainer, MainModalContainer, MenuInfoContainer } from "./index.style";

export default function MainModal(props) {
	const { serviceApplicationIdx, imgPath, cafeName, receiptPlace, receiptTime, grade, drinkInfos, closeModal } = props;
